...
_ahshift   dw 12
_kernelname   db "KERNEL",0
if __WINDOWS1__
else
_msgbox_message db "A newer version of Windows is required to run this application", 0
_msgbox_title db "MS-DOS"
endif
...
if __WINDOWS1__
        ...
        mov     ax,0
        push    ax
        mov     ax,seg _msgbox_message
        push    ax
        mov     ax,offset _msgbox_message
        push    ax
        mov     ax,seg _msgbox_title
        push    ax
        mov     ax,offset _msgbox_title
        push    ax
        mov     ax,2000h                ; MB_OK | MB_TASKMODAL
        push    ax
        call    MESSAGEBOX
        jmp     exit
l2:
endif
        mov     ax,seg _kernelname
        push    ax
        mov     ax,offset _kernelname
        push    ax
...
l3:
        ...
        rep     stosb                   ; . . .
        mov     ax,_ahshift             ; get huge shift value
        mov     _HShift,al              ; ...
        cmp     al,12                   ; real mode?
